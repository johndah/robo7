...
parser.add_argument('--dataset_dir', type=str, default='/home/jtao/robo7_vision/data/Classify', help='tfrecord file dir')
parser.add_argument('--num_samples', type=int, default=20000, help='the number of train samples')
